...
const peakHoursData = [
  { name: "Morning (6-12)", value: 25, color: "#39FF14" },
  { name: "Afternoon (12-18)", value: 45, color: "#00E5FF" },
  { name: "Evening (18-24)", value: 30, color: "#FF6B00" },
];
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex items-center justify-between">
        ...
        <button className="flex items-center gap-2 px-6 h-12 bg-white/5 hover:bg-white/10 dark:bg-[#0A0E1A]/5 dark:hover:bg-[#0A0E1A]/10 border border-white/20 dark:border-[#0A0E1A]/20 rounded-[12px] transition-all font-['Poppins',sans-serif] text-[14px] font-semibold text-white dark:text-[#0A0E1A]">
            ...
            >
              <div className="flex items-center justify-between mb-4">
                ...
                >
                  ...
                  />
                  <span className="font-['Poppins',sans-serif] text-[12px] font-semibold">
                    {kpi.change}
                  </span>
                </div>
              </div>
              ...
              <p className="font-['Poppins',sans-serif] font-bold text-[28px] text-white dark:text-[#0A0E1A]">
                {kpi.value}
              </p>
            </motion.div>
          );
      ...
      >
        ...
        <ResponsiveContainer width="100%" height={300}>
          <BarChart data={courtUsageData}>
            ...
            />
            <Bar dataKey="usage" fill="#39FF14" radius={[8, 8, 0, 0]} />
          </BarChart>
        </ResponsiveContainer>
      </motion.div>
    </div>
