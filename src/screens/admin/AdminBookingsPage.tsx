          ...
          <div className="space-y-4">
            <div className="space-y-4 sm:hidden">
              {filtered.map((booking) => {
                ...
                return (
                  <div key={booking.id} className="bg-card border border-border rounded-[32px] p-4 shadow-sm">
                    <div className="flex items-start justify-between gap-4">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <p
                            className="text-sm font-bold text-foreground font-['Poppins'] hover:text-accent cursor-pointer"
                    ...
                    <div className="mt-4 grid gap-3 text-sm text-muted-foreground font-['Poppins']">
                    ...
                    <div className="mt-4 space-y-3">
                      {isPending && (
                        <div className="grid gap-3">
                          <button
                            ...
                            disabled={isActing}
                            className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-emerald-400/10 text-emerald-400 rounded-2xl hover:bg-emerald-400 hover:text-white transition-all text-sm font-bold font-['Poppins'] disabled:opacity-50"
                          >
                          ...
                          <button
                            ...
                            disabled={isActing}
                            className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-red-500/10 text-red-500 rounded-2xl hover:bg-red-500 hover:text-white transition-all text-sm font-bold font-['Poppins'] disabled:opacity-50"
                          >
                            <XCircle size={14} />
                            Reject
                          </button>
                      ...
                      {(booking.status === 'confirmed' || booking.status === 'accepted') && (
                        <div className="grid gap-3">
                          {booking.match ? (
                            <span className="w-full inline-flex items-center justify-center px-4 py-3 bg-blue-400/10 text-blue-400 rounded-2xl text-sm font-bold font-['Poppins']">
                              Match started
                            </span>
                          ) : (
                            <button
                              ...
                              disabled={isActing}
                              className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-blue-400/10 text-blue-400 rounded-2xl hover:bg-blue-400 hover:text-white transition-all text-sm font-bold font-['Poppins'] disabled:opacity-50"
                            >
