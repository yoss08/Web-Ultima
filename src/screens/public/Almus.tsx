...
function Section2() {
  return (
    <div className="bg-gradient-to-b from-[#0a0e1a] h-[1007px] overflow-clip relative shrink-0 to-[#0a0e1a] via-1/2 via-[#0f1425] w-full" data-name="Section">
      <Container15 />
      <Container16 />
      <p className="absolute font-['Playfair:Bold',sans-serif] font-bold h-[186px] leading-[70.4px] left-[56px] text-[64px] text-white top-[141.63px] w-[444px] whitespace-pre-wrap" style={{ fontVariationSettings: "'opsz' 12, 'wdth' 100" }}>
        Why choose ALMUS
      </p>
      <Container18 />
      <Container19 />
...
function Button13() {
  return (
    <div className="-translate-x-1/2 absolute bg-[#00e5ff] h-[55px] left-[calc(45.83%+20.67px)] rounded-[33554400px] shadow-[0px_0px_20px_0px_rgba(0,229,255,0.3)] top-[5067px] w-[222px]" data-name="Button">
...
export default function Almus() {
  return (
    <div className="bg-white relative size-full" data-name="almus">
      <PY />
      <Navigation />
      <Button13 />
    </div>
