          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-4">
              ...
              <div className="text-right">
                <Link
                  to="/forgot-password"
                  className="font-['Poppins',sans-serif] text-[13px] text-accent hover:text-accent/80 transition-colors"
                >
                  Forgot password?
                </Link>
              </div>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full h-14 bg-accent rounded-[28px] shadow-lg shadow-accent/20 hover:shadow-accent/40 hover:scale-[1.02] disabled:scale-100 transition-all duration-300 font-['Poppins',sans-serif] font-bold text-[16px] text-accent-foreground mt-6 flex items-center justify-center gap-2"
            >
              {loading ? (
                <>
