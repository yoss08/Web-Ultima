    ...
    <div className="min-h-screen bg-background text-foreground transition-colors duration-300">
      ...
      <section className="relative overflow-hidden py-28 px-6">
        ...
        <div className="max-w-5xl mx-auto text-center relative z-10">
          <motion.p
            ...
            className="text-accent font-black text-sm uppercase tracking-[0.3em] mb-4"
          >
            About ULTIMA
          </motion.p>
          <motion.h1
          ...
          >
            Redefining <span className="text-accent">Sports</span> Technology
          </motion.h1>
          <motion.p
      ...
      <section className="py-20 px-6 bg-gray-50 dark:bg-white/[0.02]">
        <div className="max-w-6xl mx-auto grid md:grid-cols-3 gap-8">
          {[
            { icon: Target, title: "Our Mission", desc: "Empower every athlete with smart technology that reveals their true potential, making professional-grade analytics accessible to everyone.", color: "var(--theme-accent)" },
            { icon: Eye, title: "Our Vision", desc: "A world where every court is intelligent, every match provides insights, and every player has a data-driven path to excellence.", color: "var(--theme-accent)" },
            { icon: Heart, title: "Our Values", desc: "Innovation without complexity. Performance with purpose. Community through competition. We believe technology should elevate, not complicate.", color: "var(--theme-accent)" },
          ].map((item, i) => (
            <motion.div
              key={item.title} custom={i} initial="hidden" whileInView="visible" viewport={{ once: true }}
              variants={fadeUp}
              className="p-8 rounded-[28px] border border-border bg-card/10 hover:border-accent/30 transition-all"
            >
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div className="grid grid-cols-2 gap-4">
                {[
                  ...
                  <div key={stat.label} className="bg-card p-5 rounded-2xl border border-border text-center">
                    <p className="text-2xl font-black text-accent">{stat.num}</p>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="space-y-4">
              <a href="tel:+1234567890" className="flex items-center gap-4 p-5 bg-card rounded-2xl border border-border hover:border-accent/40 transition-all group">
              ...
              <a href="mailto:contact@ultima-sport.com" className="flex items-center gap-4 p-5 bg-card rounded-2xl border border-border hover:border-accent/40 transition-all group">
                <div className="p-3 bg-accent/10 rounded-xl group-hover:scale-110 transition-transform">
